        ...
        {loading ? (
          ...
          <>
            ...
            <Card hover className="flex flex-col justify-center">
              <p className="text-xs font-medium text-surface-500 uppercase tracking-wide mb-3">Breakdown Kategori</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
        ...
        <Card padding="lg" className="lg:col-span-2">
          <div className="flex items-center justify-between mb-5">
            <div>
              <h2 className="text-sm font-semibold text-surface-800">Tren Kepatuhan Minum Obat</h2>
          ...
          {chartData.length === 0 ? (
            ...
            <ResponsiveContainer width="100%" height={260}>
              <BarChart data={chartData} barCategoryGap="30%" barGap={4}>
                ...
                <YAxis tick={{ fontSize: 12, fill: '#73736b' }} axisLine={false} tickLine={false} allowDecimals={false} />
                <Tooltip
                  contentStyle={{
                    borderRadius: '10px',
                    border: '1px solid #e8e8e0',
                    boxShadow: '0 4px 12px rgba(20,20,18,0.08)',
                    fontSize: '13px',
                  }}
                />
        ...
        <Card padding="lg">
          <h2 className="text-sm font-semibold text-surface-800 mb-5">Status Kategori Hari Ini</h2>
              ...
              return (
                <div key={cat} className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-surface-800">{CATEGORY_LABELS[cat]}</p>
                  ...
                  <span className="text-lg font-bold text-surface-800">{count}</span>
                </div>
              )
            })}
          </div>
